...
int emcFormat(NMLTYPE type, void *buffer, CMS * cms)
{
    ...
    case EMC_TASK_PLAN_SIMPLE_RUN_TYPE:
        ((EMC_TASK_PLAN_SIMPLE_RUN *) buffer)->update(cms);
        break;
...
const char *emc_symbol_lookup(uint32_t type)
{
    ...
    case EMC_TASK_PLAN_SIMPLE_RUN_TYPE:
        return "EMC_TASK_PLAN_SIMPLE_RUN";
    case EMC_TASK_PLAN_STEP_TYPE:
...
/*
*       NML/CMS Update function for EMC_TASK_PLAN_SIMPLE_RUN
*       Manually generated by Moses McKnight
*       on Wed May 25 2016
*/
void EMC_TASK_PLAN_SIMPLE_RUN::update(CMS * cms)
{
